...
LIAPICALL (int, limdl_partition_init_copy, (LIMdlPartition*       self,
											const LIMdlPartition* partition));

LIAPICALL (void, limdl_partition_clear, (LIMdlPartition* self));

LIAPICALL (int, limdl_partition_read, (LIMdlPartition* self,
									    LIArcReader*   reader));

LIAPICALL (int, limdl_partition_write, (const LIMdlPartition* self,
										LIArcWriter*          writer));
