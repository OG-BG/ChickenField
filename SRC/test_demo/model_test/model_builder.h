...
LIAPICALL (LIMdlBuilder*, limdl_builder_new, (LIMdlModel* model));

LIAPICALL (void, limdl_builder_free, (LIMdlBuilder* self));

LIAPICALL (int, limdl_builder_add_detail_levels, (LIMdlBuilder* self,
												  int           count));

LIAPICALL (int, limdl_builder_calculate_lod, (LIMdlBuilder* self,
											  int           levels,
											  float         factor));

LIAPICALL (int, limdl_builder_find_vertex, (LIMdlBuilder*      self,
											const LIMdlVertex* vertex));

LIAPICALL (int, limdl_builder_finish, (LIMdlBuilder* self,
