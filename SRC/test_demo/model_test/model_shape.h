...
LIAPICALL (int, limdl_shape_init_copy, (LIMdlShape*       self,
									    const LIMdlShape* shape));

LIAPICALL (void, limdl_shape_clear, (LIMdlShape* self));

LIAPICALL (int, limdl_shape_read, (LIMdlShape*  self,
								   LIArcReader* reader));

LIAPICALL (int, limdl_shape_write, (const LIMdlShape* self,
									LIArcWriter*      writer));

LIAPICALL (void, limdl_shape_get_center, (const LIMdlShape* self,
												 vec3*      result));
