 ...
 * \return Vector.
 */
static inline LIMatVector2d limat_vector2d_init(float x, float y)
{
 ...
 * \return Vector.
 */
static inline int limat_vector2d_compare(LIMatVector2d self,
 ...
 * \return Vector.
 */
static inline LIMatVector2d limat_vector2d_invert(LIMatVector2d self)
{
