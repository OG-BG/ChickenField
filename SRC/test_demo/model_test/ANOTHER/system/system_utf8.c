 ...
 */
int lisys_utf8_get_char(const char* self, wchar_t*    result)
{
	int i;
	int len;
	wchar_t ch;
 ...
 */
int lisys_utf8_get_length(const char* self)
{
	const char* ptr;
	wchar_t dummy;
	int length = 0;
 ...
 */
char* lisys_utf8_get_next(const char* self)
{
 ...
 */
int lisys_utf8_get_valid(const char* self)
{
	const char* ptr;
	wchar_t dummy;
 ...
 */
wchar_t* lisys_utf8_to_wchar(const char* self)
{
	int i = 0;
	int length;
	const char* ptr;
 ...
 */
char* lisys_wchar_to_utf8(wchar_t self)
{
	int i;
	int first;
	int len = 0;    
