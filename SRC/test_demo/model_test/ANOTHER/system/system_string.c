...
#include<stdarg.h>
#include<string.h>
#include<3rdparty/libiconv/iconv.h>
 ...
 */
char* lisys_string_dup(const char* self)
{
	int i;
	char* dup;
 ...
 * \return New string or NULL.
 */
char* lisys_string_dupn(const char* self,
						int 		count)
{
	int i;
	char* dup;
 ...
 * \return New string or NULL.
 */
char* lisys_string_concat(const char* self,
						  const char* string)
{
	int len1;
	int len2;
 ...
 * \return New string or NULL.
 */
char* lisys_string_format(const char* format, ...)
{
	int len;
	int num;
	char* buf;
 ...
 */
int lisys_string_split(const char* self,
					   char 	   separator,
					   char***     result,
					   int*        resultn)
{
...
char* lisys_string_convert_sys_to_utf8(const char* str)
{
	char* tmp;
	char* inbuf;
	char* outbuf;
