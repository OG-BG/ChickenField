 ...
 */
void lisys_error_append(const char* format, ...)
{
	int num;
	va_list args;
	LISysError* data;
 ...
 * \return Error type.
 */
int lisys_error_get(const char** text)
{
	int type;
	LISysError* data;
 ...
 */
const char* lisys_error_get_string ()
{
	const char* ret;
