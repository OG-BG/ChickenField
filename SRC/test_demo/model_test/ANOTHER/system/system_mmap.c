 ...
 */
LISysMmap* lisys_mmap_open(const char* path)
{
#ifdef HAVE_SYS_MMAN_H
	int fd;
	struct stat st;
 ...
 */
void lisys_mmap_free(LISysMmap* self)
{
#ifdef HAVE_SYS_MMAN_H
	if (self->buffer != NULL)
 ...
 */
void* lisys_mmap_get_buffer(LISysMmap* self)
{
	return self->buffer;
}
 ...
 */
int lisys_mmap_get_size(LISysMmap* self)
{
	return self->size;
}
