...
static char* private_concat_paths(const char* a,
								  const char* b);
 ...
 */
LISysDir* lisys_dir_open(const char* path)
{
	LISysDir* self;
 ...
 */
void lisys_dir_free(LISysDir* self)
{
	int i;
 ...
 */
int lisys_dir_scan(LISysDir* self)
{
	int i;
	int num = 0;
	int cap = 16;
 ...
 */
int lisys_dir_get_count(const LISysDir* self)
{
 ...
 */
const char* lisys_dir_get_name(const LISysDir* self,
							   int             i)
{
	lisys_assert (i >= 0);
 ...
 */
char* lisys_dir_get_path(const LISysDir* self,
						 int             i)
{
	lisys_assert (i >= 0);
	lisys_assert (i < self->names.count);
 ...
 */
void lisys_dir_set_filter(LISysDir*      self,
						  LISysDirFilter filter,
						  void*          data)
{
 ...
 */
void lisys_dir_set_sorter(LISysDir*      self,
						  LISysDirSorter sorter)
{
 ...
 */
int lisys_dir_filter_files(const char* dir,
						   const char* name,
						   void*       data)
{
	char* path;
 ...
 */
int lisys_dir_filter_dirs(const char* dir,
						  const char* name,
						  void*       data)
{
	char* path;
 ...
 */
int lisys_dir_filter_hidden(const char* dir,
							const char* name,
							void*       data)
{
	if (name[0] == '.')
 ...
 */
int lisys_dir_filter_visible(const char* dir,
							 const char* name,
							 void*       data)
{
	if (name[0] == '.')
 ...
 */
int lisys_dir_sorter_alpha(const char** name0,
						   const char** name1)
{
