...
static int private_validate_dir(char** path);

static int private_create_save_path(LIPthPaths* paths,
									const char* path);
 ...
 */
LIPthPaths* lipth_paths_new(const char* path,
							const char* name)
{
	char* tmp;
	LIPthPaths* self;
 ...
 */
int lipth_paths_add_path(LIPthPaths* self,
						 const char* path)
{
	int ret = 1;
	char* path1;
 ...
 */
int lipth_paths_add_path_abs(LIPthPaths* self,
							 const char* path)
{
	int i;
	int c;
 ...
 */
const char* lipth_paths_create_file(LIPthPaths* self,
									const char* name,
									int         config)
{
	char* path;
 ...
 * \return path Absolute path or NULL.
 */
const char* lipth_paths_find_file(LIPthPaths* self,
								  const char* name)
{
 ...
 */
char* lipth_paths_find_path(const LIPthPaths* self,
							const char*       path,
							int               config)
{
	char* path1;
...
static int private_create_save_path(LIPthPaths* self,
									const char* path)
{
